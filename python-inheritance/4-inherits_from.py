...
est une instance d'une sous-classe d'une classe donnée (mais pas de la classe elle-même).
"""
def inherits_from(obj, a_class):
    """
    Vérifie si obj est une instance d'une sous-classe de a_class (directement ou indirectement).
